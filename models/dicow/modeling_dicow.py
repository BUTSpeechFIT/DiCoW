...
if not hasattr(whisper_mod, "WHISPER_ATTENTION_CLASSES"):
    whisper_mod.WHISPER_ATTENTION_CLASSES = {
        "eager": getattr(whisper_mod, "WhisperAttention", None),
    }
    if hasattr(whisper_mod, "WhisperSdpaAttention"):
        whisper_mod.WHISPER_ATTENTION_CLASSES["sdpa"] = whisper_mod.WhisperSdpaAttention
    if hasattr(whisper_mod, "WhisperFlashAttention2"):
        whisper_mod.WHISPER_ATTENTION_CLASSES["flash_attention_2"] = whisper_mod.WhisperFlashAttention2
